...
class cpure():
    ...
    def sresa(self, V, T, D, B):
        ...
        alf = 1 + self.k * (1 - (T/self.Tc) ** 0.5) ** 2
        dalfdT = 2 * (1 + self.k * (1 - (T/self.Tc) ** 0.5)) * 0.5* (-self.k * (T/self.Tc) ** (-0.5)) * (1/self.Tc)
        dadT = self.oma*(R*self.Tc)**2*dalfdT/self.Pc
        Fa = - dadT * f
        return - Fa * r

    def EntropyRr(self, T, P, state, v0=None, T_Step=0.1):
        ...
        F1 = self.aresr(V, T1, D1, B)
        F2 = self.aresr(V, T2, D2, B)
        F_1 = self.aresr(V, T_1, D_1, B)
        F_2 = self.aresr(V, T_2, D_2, B)
    ...
    def EntropyRa(self, T, P, state, v0=None, T_Step=0.1):
        ...
        F1 = self.aresa(V, T1, D1, B)
        F2 = self.aresa(V, T2, D2, B)
        F_1 = self.aresa(V, T_1, D_1, B)
        F_2 = self.aresa(V, T_2, D_2, B)
